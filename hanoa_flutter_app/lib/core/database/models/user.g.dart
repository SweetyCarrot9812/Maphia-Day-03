...
extension UserQueryFilter on QueryBuilder<User, User, QFilterCondition> {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> isCurrentUserEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
...
extension UserQuerySortBy on QueryBuilder<User, User, QSortBy> {
  ...
  QueryBuilder<User, User, QAfterSortBy> sortByIsCurrentUser() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isCurrentUser', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> sortByIsCurrentUserDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension UserQuerySortThenBy on QueryBuilder<User, User, QSortThenBy> {
  ...
  QueryBuilder<User, User, QAfterSortBy> thenByIsCurrentUser() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isCurrentUser', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> thenByIsCurrentUserDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isCurrentUser', Sort.desc);
    });
  }
...
extension UserQueryWhereDistinct on QueryBuilder<User, User, QDistinct> {
  ...
  QueryBuilder<User, User, QDistinct> distinctByIsCurrentUser() {
    return QueryBuilder.apply(this, (query) {
...
extension UserQueryProperty on QueryBuilder<User, User, QQueryProperty> {
  ...
  QueryBuilder<User, bool, QQueryOperations> isCurrentUserProperty() {
    return QueryBuilder.apply(this, (query) {
